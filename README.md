...
In the **helper.py** file, the `clean_portfolio`, `clean_profile` and `clean_transcript` functions are
...
### 5. medium article for this project in this [LINK](https://medium.com/@mohamedabdelrazek_14826/starbucks-capstone-challenge-52866a9027d5)
